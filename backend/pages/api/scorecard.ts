...
import { buildScorecard } from '../../lib/calculators'
...
export default function handler(
  ...
  if (typeof sprint === 'string' && sprint.length > 0) {
    data = buildScorecard(sprint, projectName, undefined, undefined, filterType)
  } else if (typeof startDate === 'string' && typeof endDate === 'string' && startDate && endDate) {
    data = buildScorecard(null, projectName, startDate, endDate, filterType)
  } else {
